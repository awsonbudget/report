...
# URL = "https://winter2023-comp598-group06-02.cs.mcgill.ca/medium/sort/200/200/"  # The endpoint to send requests to
# URL = "https://winter2023-comp598-group06-02.cs.mcgill.ca/heavy/sort/100/500/"  # The endpoint to send requests to
...
async def send_requests(URL: str):
    start_time = time.monotonic()
    tasks = []
    latencies = []
...
if __name__ == "__main__":
    target = sys.argv[1]
    numStrings = sys.argv[2]
    stringLength = sys.argv[3]

    URL = f"https://winter2023-comp598-group06-02.cs.mcgill.ca/{target}/sort/{numStrings}/{stringLength}/"

    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)
    loop = asyncio.get_event_loop()
    total_time, latencies = loop.run_until_complete(send_requests(URL))
